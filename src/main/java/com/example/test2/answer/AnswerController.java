...
import com.example.test2.question.QuestionForm;
...
public class AnswerController {
    ...
    public String answerModify(@Valid QuestionForm questionForm, BindingResult bindingResult,
        ...
        this.answerService.modify(answer, questionForm.getContent());
        return String.format("redirect:/question/detail/%s#answer_%s",
                answer.getQuestion().getId(), answer.getId());
    }
